...
// Create a service role client for database operations with schema refresh
export const supabaseAdmin = supabaseServiceKey ? createClient(supabaseUrl, supabaseServiceKey, {
  ...
  global: {
    headers: {
      'X-Client-Info': 'jayna-gyro-app'
    }
  }
}) : null

// Create a client for browser operations with schema refresh

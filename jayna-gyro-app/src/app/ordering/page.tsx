    ...
    >
      ...
      {activeTab === 'inventory' && (
        <div>
          <div className="flex justify-between items-center mb-6">
            ...
            <Button onClick={() => router.push('/ordering/custom-list')}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {categories.map((category) => (
              <Card
                ...
                onClick={() => router.push(`/ordering/category/${category.key}`)}
              >
      ...
      {activeTab === 'orders' && (
        <div>
          ...
          <Button onClick={() => router.push('/ordering/new-order')} className="w-full">
            <Plus className="h-4 w-4 mr-2" />
